...
<table>
<tr><td>Ingrese el peso Inicial</td><td><input type="text" name="edadinic"  value="<?php echo ($resid) ?>"  ></td></tr>
<tr><td>Ingrese el peso Final</td><td><input type="text"  name="edadfin" value="<?php echo ($resnom) ?>"  ></td></tr>
</table>
...
if(isset($_POST['busqueda']))
{
    ...
    if($edadinic>$edadfin){
        ...
        <script language="javascript">alert("Error: El peso inicial no puede ser mayor que al peso final");</script>
    
        <?php
    }else{

    $sql1 = "SELECT dieta.nombred, menu.comida, alimentos.alimento, alimentos.porcion FROM paciente,die_paci,menu,alimentos,dieta WHERE pesop BETWEEN $resid and $resnom
