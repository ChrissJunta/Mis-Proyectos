  ...
  <div class="settings" style="padding-bottom:0px;">
    <div class="right_section importexport">
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("All Settings",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input <?php disabled($_disable, true, true) ?> type="submit" name="export_general_settings" value=" <?php _e("Export","pie-register"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php disabled($_disable, true, true) ?>  type="submit" name="import_general_settings" value=" <?php _e("Import","pie-register"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("E-mail Templates",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php disabled($_disable, true, true) ?> type="submit" name="export_email_template" value=" <?php _e("Export","pie-register"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php disabled($_disable, true, true) ?> type="submit" name="import_email_template" value=" <?php _e("Import","pie-register"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("Invitation Codes",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php disabled($_disable, true, true) ?> type="submit" name="export_invitations_codes" value=" <?php _e("Export","pie-register"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php disabled($_disable, true, true) ?> type="submit" name="import_invitations_codes" value=" <?php _e("Import","pie-register"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("All User Data with Custom Fields",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <?php
        ...
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php disabled($_disable, true, true) ?> type="submit" name="piereg_export_user_custom_data" value=" <?php _e("Export","pie-register"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php disabled($_disable, true, true) ?> type="submit" name="piereg_import_user_custom_data" value="<?php _e("Import","pie-register"); ?>" 
            					onclick="validImportForm(this.form, '.import_all_users_data_with_custom_field')" 
                                class="button button-primary button-large"  />
              <span class="quotation width-63"><strong>
              <?php _e("Warning","pie-register"); ?>
              </strong>:
              <?php _e("Only json format is supported <em>(for backup purpose)</em>","pie-register"); ?>
              </span></div>
          </form>
        </div>
      </fieldset>
