...
<div class="right_section">
  ...
  <form method="post" action="#piereg_admin_notification">
    ...
    <div class="notification-accordion">
      <div class="notification-item">
        <div class="notification-item-toggler">
          <p><?php _e('Default - Admin Notification' ,"pie-register"); ?></p>
      ...
      <div class="notification-item">
        <div class="notification-item-toggler">
          <p><?php _e('Admin Notification On Profile Update' ,"pie-register"); ?></p>
        ...
        <div class="content clearfix">
          <ul class="clearfix">
            <li class="hide-div clearfix">
              <div class="fields">
                <input name="enable_admin_notifications_profile_update" <?php checked($piereg['enable_admin_notifications_profile_update'] == "1", true, true); ?> type="checkbox" class="checkbox" value="1" />
                <?php _e("Enable email notifications to administrator On Profile Update",'pie-register');?>  
                <label style="font-size:12px;margin-bottom:10px;margin-top:10px;font-size:14px;"><i><?php _e("Note: If the default WP Login page is used, Email verification links will not work.",'pie-register');?></i></label>            
              </div>
            </li>
            <li class="hide-div clearfix">
            ...
            <li class="hide-div clearfix">
              <div class="fields flex-format">
                <div class="radio_fields">
                    <input type="checkbox" name="admin_message_email_formate_profile_update" id="admin_message_email_formate_profile_update" value="1" <?php checked($piereg['admin_message_email_formate_profile_update'] == "1", true, true); ?> />	
                </div>
                <label class="labelaligned"><?php _e("Email HTML Format",'pie-register');?></label>
              </div>
            </li>
    ...
    <p class="submit"><input class="submit_btn notify-submit-btn" name="Submit" value="<?php _e('Save Changes','pie-register');?>" type="submit" /></p>
    </form>
  </div>
</div>