	...
	function addPassword(  $noPasswordField=false ){
		...
		if( isset($this->field['password_generator']) && $this->field['password_generator'] != "" ){
			...
			if ( !$noPasswordField )
			{
				...
				$data .= '<li class="fields pageFields_'.$this->pages.' '.$topclass.'">';
					$data .= '<div class="fieldset"><label>'.__("Password","pie-register").'</label>';
						$data .= '<input id="new_password" name="password" data-field_id="piereg_field_'.$this->no.'" class="input_fields piereg_validate[minSize[8]]" type="password" value="" autocomplete="off" >';
						$data .= '<span class="show-hide-password-innerbtn pass-eye-update eye"></span>';
					$data .= '</div>';
				$data .= '</li>';
				$data .= '<li class="fields pageFields_'.$this->pages.' '.$topclass.'"><div class="fieldset">';
					$data .= '<label>'.__("Confirm Password","pie-register").'</label>';
					$data .= '<div '.$fclass.'><input id="confirm_password_'.$this->id.'" type="password" class="input_fields  piereg_validate[equals[new_password]]" value="" name="confirm_password" autocomplete="off">';
					$data .= $this->addDesc();
					$data .= '</div>';
					$data .= '</div>';
				$data .= '</li>';
