...
function getStyle(type) {
    ...
    */
    ...
    if (type == "text") {
        ...
        html.find("#field_position_" + no).after('<div id="confirm_password_field" class="fields_position"> <input disabled="disabled" type="text" class="input_fields"></div>');

        html.find("#field_position_" + no).after('<div class="label_position"><label>Confirm Password</label></div>');
    }
