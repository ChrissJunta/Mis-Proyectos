...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/MUY FACIL/1.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        ...
        imagenes: [
            ...
            "./img/MUY FACIL/N4.png",
            "./img/MUY FACIL/N2.png",
            "./img/MUY FACIL/N3.png",
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste" ,
                    html: `<audio src="./audio/perdiste.mp4" autoplay>
                    <p>Tu navegador no implementa el elemento audio.</p>
                    </audio>
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `<audio src="./audio/ganaste.mp4" autoplay>
                    <p>Tu navegador no implementa el elemento audio.</p>
                    </audio>
                <img class="img-fluid" src="./img/ganador1.png" alt="Ganaste">
