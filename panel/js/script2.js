...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/MUY FACIL/2.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                ...
                <img class="img-fluid" src="./img/perdiste2.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                ...
                <img class="img-fluid" src="./img/ganador2.png" alt="Ganaste">
