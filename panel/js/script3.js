...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/MUY FACIL/3.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                ...
                <img class="img-fluid" src="./img/perdeiste3.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                ...
                <img class="img-fluid" src="./img/ganador3.png" alt="Ganaste">
